                ...
                <div className="card  bg-dark text-white"  key={exp.id} >
                    ...
                    <div className="card-body">
                        ...
                        <strong>Description: </strong><p className="card-text">{exp.description} </p>
                         <strong>Tools Used: </strong><p> {exp.tools} <br/>
                        { exp.github && <a className="fa" href={exp.github}  target="_blank" ><FaGithubSquare/></a>}
                        { exp.hosted && <a className="card-link " href={exp.hosted}  target="_blank" >Click to visit site</a>}
                        </p>
                    </div>
                </div>
            </div> }
